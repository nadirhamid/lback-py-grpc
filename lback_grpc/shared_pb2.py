...
_BACKUPCMD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='agent_ids', full_name='lbackgrpc.BackupCmd.agent_ids', index=6,
